...
const Contact = () => {
  return (
    <section
      className="relative w-full bg-white py-24 px-4 sm:px-8 lg:px-16"
      id="contact"
    >
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        {/* 🔹 Desktop image */}
        <div className="hidden md:flex flex-1 w-full justify-start">
        ...
        <div className="flex-1 w-full flex flex-col items-center md:items-start text-center md:text-left space-y-8">
          ...
          <div className="flex items-center gap-6 mt-4">
            <a
              ...
              target="_blank"
              className="p-3 rounded-full bg-gray-50 hover:bg-gray-100 text-gray-600 hover:text-gray-900 transition-all duration-300 hover:scale-110"
            ...
            <a
              href="https://www.linkedin.com/in/jibin-stephen"
              target="_blank"
              className="p-3 rounded-full bg-gray-50 hover:bg-gray-100 text-gray-600 hover:text-gray-900 transition-all duration-300 hover:scale-110"
              aria-label="LinkedIn"
            >
